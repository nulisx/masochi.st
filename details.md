...
good now i want you to like fully really analyze the izZ9i.png image analyze it entirely find every spec and everything every aspect of it yk what i mean and fix it entirely up where with the text glowi.es next to the image in the dash top left make the text size the same size as sexi.st is in the izZ9i.png image
