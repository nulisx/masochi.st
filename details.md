...
go through the source code and fix this entirely because it wont let me login to the dash w my default owner acc credentials because yes as i do want to finish this entirely but i want you to continue because i want professional monochromatic icons with consistent styling throughout all dashboard sections and i dont see icons in the dash homepage/dash overview or in the account category with profile and security neither do i see new icons in the assets category with images and litterbox and neither do i see new icons for also settings or privacy fix this all up entirely i want new icons everywhere better icons and everything entirely as of what i said: good now finally add icons for the icons in the litterbox and images assets in dash fix the icons in those categories i want real icons for everywhere change up the icons make the best icons find actual icons ion want colored icons i want icons like on the sidebar those typa icons but way better fix up all the icons in the dash and make it entirely better icons as well as what i said here: did you also add real icons and updated icons to the dashboard overview page along with profile, security, settings and privacy of when i said finally add icons for the icons in the litterbox and images assets in dash fix the icons in those categories i want real icons for everywhere change up the icons make the best icons find actual icons ion want colored icons i want icons like on the sidebar those typa icons but way better fix up all the icons in the dash and make it entirely better icons fix the icons entirely all of them real icons fix them its broken and wrong icons i want this to be the best icons ever i want icons without color as well as ive said above and i want you to fix it where it keeps redirecting me from logging in every time i login with username r and password ACK071675$! or email qq@fbi.one and password ACK071675$! it takes me to the dash then redirects me to login like fix this up entirely because it still isnt working it wont let me login it lets me login yes but its keeps taking me back to the login page as if im not logged in or anything or if my account isnt really working check and fix it if the default owner acc is username set as r (capitalism doesnt matter for either username nor email only matters for passwords) email set as qq@fbi.one and password set as ACK071675$! fix all of this up entirely like it lets me in the dash for 2 seconds and then keeps redirecting me to login it still isnt working analyze every file to fix the apis and auth and all that fix it entirely so how about you go through the entire source code to remove the entire redirect loop when i login it keeps redirecting me to the login/loading page then dash then after 1-2 seconds it takes me back to the login page remove it so i can loginto the dash exactly yk what i mean fix it so i can actually login the dash
