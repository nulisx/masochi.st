...
good now make it where in the Biolinks tab in the dash change the Links part to Stats make it like Realtime Analytics to like have Track clicks, views, and engagement metrics, across the biolinks with detailed statistics and insights yk what i mean and make it where in the 2nd image with the Share Your Biolink thing it detects the site url like if the site is hosted on og.email it would be og.email/@r if its hosted on marit.al it would be marit.al/@r yk what i mean detects the site url so it knows yk what i mean (this is with Biolinks1-Links.png and Biolinks2-Links.png)

now finally in the 3rd and 4th images (this is with Biolinks3-Customize.png and Biolinks4-Customize.png) make it where with the sidebar w the Customize tab in the Biolinks section in the dash the sidebar in the Customize like when i scroll down on the thing the sidebar tabs scroll down w me yk what i mean stuff like that yk and update the Biolinks tab css inside of it to match the dash css yk what i mean like the sidebar tabs in the customize make it have purple border dashed as well yk what i mean like the dash sections have it when ur on that current section yk what i mean fix the css up entirely make it match and stuff make it the best entirely yk what i mean