...
- **Icon Hover Rotation Effect (Nov 30)**:
  ...
  - Animation: Slows down as it approaches 180°, pauses while upside down, then continues
  - Total animation time: 1.3s with smooth cubic-bezier easing
  - Visual effect: deceleration on approach, pause, acceleration on return
