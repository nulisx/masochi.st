    ...
    getSocialPlatforms() {
        return [
            ...
            { 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#FF5500" stroke-width="2"><path d="M3 13.5c0 1.657 1.343 3 3 3s3-1.343 3-3M9 13.5c0 1.657 1.343 3 3 3s3-1.343 3-3M15 13.5c0 1.657 1.343 3 3 3s3-1.343 3-3"/><path d="M8 10l-2-4m4 8l-1-6m4 8l1-8m4 8l2-4"/></svg>`
            },
            { 
                name: 'PayPal', 
                prefix: 'paypal.me/', 
            ...
            { 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#00D632" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><text x="12" y="16" font-size="12" text-anchor="middle" font-weight="bold">$</text></svg>`
            },
            { 
                name: 'Brave', 
                prefix: '', 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="#FB542B"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2m0 2c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8m3.5 6c.828 0 1.5.672 1.5 1.5S16.328 13 15.5 13 14 12.328 14 11.5 14.672 10 15.5 10m-7 0c.828 0 1.5.672 1.5 1.5S9.328 13 8.5 13 7 12.328 7 11.5 7.672 10 8.5 10m3.5 5c1.657 0 3 1.343 3 3H9c0-1.657 1.343-3 3-3z"/></svg>`
            },
            { 
                name: 'Twitch', 
                prefix: 'twitch.tv/', 
            ...
            { 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#53FC18" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><text x="12" y="17" font-size="14" text-anchor="middle" font-weight="bold">K</text></svg>`
            },
            { 
                name: 'Reddit', 
                prefix: 'reddit.com/u/', 
            ...
            { 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#FF6600" stroke-width="2"><circle cx="12" cy="12" r="9"/><text x="12" y="15" font-size="10" text-anchor="middle" font-weight="bold">M</text></svg>`
            },
            { 
                name: 'Mail', 
                prefix: 'mailto:', 
            ...
            { 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#4caf50" stroke-width="2"><rect x="4" y="4" width="16" height="16"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="12" y1="4" x2="12" y2="20"/></svg>`
            },
            { 
                name: 'Steam', 
            ...
            { 
                ...
                icon: `<svg viewBox="0 0 24 24" width="24" height="24" fill="#FC6D26"><path d="M12 1.5l-5 5v5H5l7 7 7-7h-2v-5l-5-5zm0 3l2.5 2.5h-5L12 4.5zm0 6h3v3l-3 3-3-3v-3h3z"/></svg>`
            },
            { 
                name: 'Custom URL', 
                prefix: '', 
