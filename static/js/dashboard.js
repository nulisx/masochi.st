        ...
        contentArea.innerHTML = `
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
                <div class="card" style="border: 1px dashed rgba(128, 128, 128, 0.35); position: relative; overflow: hidden;">
                    <div class="card-header">
                        <div class="card-icon" style="background: rgba(59, 130, 246, 0.15); color: #3b82f6;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div style="position: absolute; bottom: -55px; right: -10px; width: 150px; height: 150px; pointer-events: none; display: flex; align-items: center; justify-content: center;">
                        <svg width="120" height="120" viewBox="0 0 24 24" style="opacity: 0.08; stroke: #3b82f6; transform: rotate(25deg);" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 21L7.18762 18.9912C4.55966 17.1141 3 14.0834 3 10.8538L3 5.75432C3 5.30784 3.29598 4.91546 3.72528 4.7928L9.72528 3.07852C9.90483 3.02721 10.0952 3.02721 10.2747 3.07852L16.2747 4.7928C16.704 4.91546 17 5.30784 17 5.75432V7.50002M19 15V13C19 11.8955 18.1046 11 17 11C15.8954 11 15 11.8955 15 13V15M19 15H15M19 15C20.1046 15 21 15.8955 21 17V19C21 20.1046 20.1046 21 19 21H15C13.8954 21 13 20.1046 13 19V17C13 15.8955 13.8954 15 15 15" stroke="rgba(59, 130, 246, 0.25)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <rect x="13" y="12" width="6" height="6" rx="1"></rect>
                            <path d="M16 12V9a1 1 0 0 0-2 0"></path>
                        </svg>
                    </div>
                    <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 100px; background: linear-gradient(to bottom, transparent 0%, rgba(59, 130, 246, 0.3) 100%); pointer-events: none;"></div>
                </div>
                
                <div class="card" style="border: 1px dashed rgba(128, 128, 128, 0.35); position: relative; overflow: hidden;">
                    <div class="card-header">
                        <div class="card-icon" style="background: rgba(59, 130, 246, 0.15); color: #3b82f6;">
                            <svg width="20" height="20" viewBox="0 0 256 256" fill="#3b82f6" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div style="position: absolute; bottom: -55px; right: -10px; width: 150px; height: 150px; pointer-events: none; display: flex; align-items: center; justify-content: center;">
                        <svg width="120" height="120" viewBox="0 0 256 256" style="opacity: 0.08; fill: #3b82f6; transform: rotate(25deg);" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card" style="border: 1px dashed rgba(128, 128, 128, 0.35); position: relative; overflow: hidden;">
                    <div class="card-header">
                        <div class="card-icon" style="background: rgba(59, 130, 246, 0.15); color: #3b82f6;">
                            <svg width="20" height="20" viewBox="0 0 1200 1200" fill="#3b82f6" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div style="position: absolute; bottom: -50px; right: -10px; width: 150px; height: 150px; pointer-events: none; display: flex; align-items: center; justify-content: center;">
                        <svg width="120" height="120" viewBox="0 0 1200 1200" style="opacity: 0.08; fill: #3b82f6; transform: rotate(25deg);" xmlns="http://www.w3.org/2000/svg">
                            <path d="M328.261,271.758C146.977,271.758,0,418.697,0,599.981c0,181.283,146.977,328.261,328.261,328.261c161.72,0,296.083-116.959,323.206-270.903c0.306,0.017,0.605,0.064,0.912,0.076h126.386v182.46h139.538v-182.46h65.796v264.068h139.538V657.414H1200V517.878H647.095c-0.322,0.026-0.63,0.048-0.95,0.076C609.721,376.371,481.219,271.758,328.261,271.758L328.261,271.758z M328.261,423.611c97.415,0,176.37,78.955,176.37,176.37c0,97.414-78.955,176.407-176.37,176.407s-176.408-78.993-176.408-176.407C151.853,502.566,230.847,423.611,328.261,423.611L328.261,423.611z"/>
                        </svg>
                    </div>
                    <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 100px; background: linear-gradient(to bottom, transparent 0%, rgba(59, 130, 246, 0.3) 100%); pointer-events: none;"></div>
